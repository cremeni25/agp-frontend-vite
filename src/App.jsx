...
import MasterTechnicalTeam from "./pages/MasterTechnicalTeam";
...
import MasterAthleteDecisionCycle from "./pages/MasterAthleteDecisionCycle";
    ...
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/dashboard-master/administracao/equipe-tecnica" element={<ProtectedRoute tipoPermitido="master"><MasterTechnicalTeam /></ProtectedRoute>} />
          ...
          <Route path="/master/atletas/:participantId/decisao" element={<ProtectedRoute tipoPermitido="master"><MasterAthleteDecisionCycle /></ProtectedRoute>} />
          ...
          <Route path="/master/homologacao/acesso-tecnico" element={<ProtectedRoute tipoPermitido="master"><MasterInviteN1Coach /></ProtectedRoute>} />
