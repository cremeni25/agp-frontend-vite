  ...
  async function submit(event) {
    ...
    try {
      const result = await createInstitutionParticipant(form.instituicao_id, {
        ...
        perfil_esportivo: form.papel === "atleta" ? { modalidade: form.modalidade, prova_posicao: form.prova_posicao || null, categoria: form.categoria || null, nivel: form.nivel || null, dados_complementares: { esporte_id: form.esporte_id, esporte_nome: selectedSport?.nome || null, esporte_slug: selectedSport?.slug || null } } : null
      });
