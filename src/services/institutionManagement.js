...
export function listInstitutions() {
  return authorizedRequest("/api/v1/administracao/instituicoes");
}
...
export function updateInstitution(institutionId, payload) {
  return authorizedRequest(`/api/v1/administracao/instituicoes/${institutionId}`, {
    method: "PATCH",
    body: JSON.stringify(payload)
  });
}
